...
const RecentProjects = () => {
  return (
    <div className='py-10' id='projects'>
      <h1 className='heading mb-10'>A small selection of 
        <span className='text-[#d293e9]'> Recent Projects</span>
      </h1>
                    ...
                    <div className='flex items-center justify-between mt-7 mb-3'>
                        <div className='flex items-center'>
                            {iconLists.map((icon, index) => (
                                <div key={icon} className='border border-white/[0.2] rounded-full bg-black-200 lg:w-10 lg:h-10 w-8 h-8 flex justify-center items-center' style={{transform: `translateX(-${5*index}px)`}}>
