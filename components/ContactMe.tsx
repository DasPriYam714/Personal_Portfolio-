  ...
  return (
    ...
    >
      <Anime>
        ...
        <h1 className='heading mb-10'>Feel free to
        ...
        <div className="w-full shadow-xl shadow-[#5850d7]">
          <div>
            ...
            <div className="w-full lg:w-[100%] h-full py-10 bg-gradient-to-r from-[#0B1120] to-[#0B1120] flex flex-col gap-8 p-4 lg:p-8 rounded-lg shadow-shadowOne">
              <form className="w-full flex flex-col gap-4 lg:gap-6 py-2 lg:py-5">
                ...
                <div className="w-full">
                  <button
                    onClick={handleSend}
                    className="w-full h-12 bg-[#141518] rounded-lg text-base text-gray-400 tracking-wider uppercase hover:text-white duration-300 hover:border-[3px] hover:border-designColor border-[#6f3cdd] border"
                  >
                    Send Message
                  </button>
                </div>
