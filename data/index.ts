export const navItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "I emphasize client collaboration, cultivating transparent communication ",
      description: "",
      className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[80vh]",
      imgClassName: "w-full h-full",
      titleClassName: "justify-end text-wrap-3",
      img: "/b1.svg",
      spareImg: "",
    },
    {
    ...
    },
    {
      id: 3,
      title: "My tech stack",
      description: "I am continually striving for improvement",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
    ...
    {
      id: 5,
      title: "Currently working on some personal projects",
  ...
  export const projects = [
    ...
    },
    {
      ...
      img: "/Hockey.png",
      iconLists: ["/html.svg", "/tail.svg", "/css.png" ],
    ...
    },
    {
      ...
      des: "This beginner-level HTML, CSS, and JavaScript website allows users to easily book their tickets. It is responsive and a great practice project for HTML and CSS.",
      img: "/p-ticketing.png",
      iconLists: ["/javascript.png","/html.svg", "/tail.svg","/css.png" ],
